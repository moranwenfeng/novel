...
import io.github.mo.novel.core.common.util.ImgVerifyCodeUtils;
...
public class VerifyCodeManager {
    ...
    public boolean imgVerifyCodeOk(String sessionId, String verifyCode) {
        return Objects.equals(
                stringRedisTemplate.opsForValue().get(CacheConsts.IMG_VERIFY_CODE_CACHE_KEY + sessionId),verifyCode
        );
    }
